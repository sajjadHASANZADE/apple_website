...
function Model(props) {
  ...
  const texture = useTexture(props.item?.img || "/assets/images/blue.jpg"); // Use a default image if img is undefined

  useEffect(() => {
    if (props.item && materials) {
      Object.entries(materials).forEach(([materialName, material]) => {
        ...
        if (!excludedMaterials.includes(materialName)) {
          if (props.item.color && props.item.color[0]) {
